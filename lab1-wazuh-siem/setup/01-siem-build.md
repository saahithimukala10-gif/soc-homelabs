...
Two issues from this phase are kept here because they shaped later decisions.
The rest — shell profile scoping, modular libvirt daemons, and the indexer's
loopback binding — are in [troubleshooting.md](troubleshooting.md).
...
Next: [Endpoint telemetry](02-endpoint-telemetry.md).
